...
/// One-third arc of a Trainer's difficulty ring. The three segments are exact
/// thirds whose gaps sit symmetrically about the vertical axis — one gap at
/// top-centre and one on each lower flank — so the ring stays balanced no matter
/// how many tiers are lit.
