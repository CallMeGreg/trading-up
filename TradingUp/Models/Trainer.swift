...
extension Trainer {
    ...
    static let roster: [Trainer] = [
        ...
        Trainer(id: "curator", name: "Curator",
                blurb: "Reads the room. A wider Showcase and sharper synergy.",
                baseMods: { var m = RunMods.none; m.extraSlots = 1; m.synergyPerMatchBonus = 0.05; return m }(),
                unlock: TrainerUnlock(stat: GauntletStat.maxShowcase, threshold: 9,
                                      summary: "Build a Showcase of 9 cards in a single run.",
        ...
        Trainer(id: "appraiser", name: "Appraiser",
                ...
                unlock: TrainerUnlock(stat: GauntletStat.bestRoundScore, threshold: 200,
                                      summary: "Reach a round score of 200.",
        ...
        Trainer(id: "grader", name: "Grader",
                ...
                unlock: TrainerUnlock(stat: GauntletStat.cardsGraded, threshold: 12,
                                      summary: "Grade 12 cards across your Gauntlet runs.",
                                      noun: "cards graded")),
        ...
        Trainer(id: "merchant", name: "Merchant",
                ...
                unlock: TrainerUnlock(stat: GauntletStat.maxCashHeld, threshold: 120,
                                      summary: "Hold $120 cash at once during a run.",
                                      noun: "most cash held")),
    ]
