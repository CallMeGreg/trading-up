...
enum Economy {
    ...
    // Classic's quick-sale price. Collector requests and named-card exchanges
    // reward planning instead of repeatedly cashing out every duplicate.
    // Gauntlet has its own unchanged base rate in GauntletEconomy.
    static let sellbackRate = 0.60
