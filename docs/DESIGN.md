...
line carry a set-colored **Same line** tag beside their names instead of repeating
those names in the header. Completed series are labeled **Series complete** and
